    ...
    <View style={styles.container}>
      ...
      <View style={styles.bioContainer}>
        ...
        <Text style={styles.bioText}>
          Tenho 18 anos, sou brasileiro e estou cursando Técnico em Informática no Colégio Técnico Industrial "Prof. Isaac Portal Roldán" - UNESP, com previsão de conclusão em 2025.
        </Text>
        <Text style={styles.bioText}>
